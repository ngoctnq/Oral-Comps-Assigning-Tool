...
```
python2 init.py [/path/to/people/data='2016.xlsx']
python2 ampl_gen.py [/path/to/people/data='2016.xlsx'] [/path/to/division/data='academic_divisions.xlsx']
python2 parse_output.py [/path/to/people/data='2016.xlsx']
```
